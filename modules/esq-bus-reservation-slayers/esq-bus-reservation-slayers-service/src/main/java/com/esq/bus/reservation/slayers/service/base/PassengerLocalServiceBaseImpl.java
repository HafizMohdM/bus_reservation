...
import com.esq.bus.reservation.slayers.service.PassengerLocalService;
import com.esq.bus.reservation.slayers.service.PassengerLocalServiceUtil;
...
/**
 * Provides the base implementation for the passenger local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.PassengerLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.PassengerLocalServiceImpl
 * @generated
 */
public abstract class PassengerLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PassengerLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PassengerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PassengerLocalServiceUtil</code>.
	 */
	...
	public Passenger addPassenger(Passenger passenger) {
		...
		return passengerPersistence.update(passenger);
	}
	...
	public Passenger createPassenger(long passengerId) {
		return passengerPersistence.create(passengerId);
	}
	...
	public Passenger deletePassenger(long passengerId) throws PortalException {
		return passengerPersistence.remove(passengerId);
	}
	...
	public Passenger deletePassenger(Passenger passenger) {
		return passengerPersistence.remove(passenger);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return passengerPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Passenger.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return passengerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return passengerPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return passengerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return passengerPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Passenger fetchPassenger(long passengerId) {
		return passengerPersistence.fetchByPrimaryKey(passengerId);
	}
	...
	public Passenger getPassenger(long passengerId) throws PortalException {
		return passengerPersistence.findByPrimaryKey(passengerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(passengerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Passenger.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("passengerId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			passengerLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Passenger.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return passengerPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PassengerLocalServiceImpl#deletePassenger(Passenger) to avoid orphaned data");
		}

		return passengerLocalService.deletePassenger((Passenger)persistedModel);
	}

	@Override
	public BasePersistence<Passenger> getBasePersistence() {
		return passengerPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return passengerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Passenger> getPassengers(int start, int end) {
		return passengerPersistence.findAll(start, end);
	}
	...
	public int getPassengersCount() {
		return passengerPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PassengerLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		passengerLocalService = (PassengerLocalService)aopProxy;

		_setLocalServiceUtilService(passengerLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PassengerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = passengerPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PassengerLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, passengerLocalService);
		}
	...
	protected PassengerLocalService passengerLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PassengerLocalServiceBaseImpl.class);
