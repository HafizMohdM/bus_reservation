...
/**
 * The arguments resolver class for retrieving value from Payment.
 *
 * @author Brian Wing Shun Chan
 * @generated
 */
@Component(service = ArgumentsResolver.class)
public class PaymentModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= paymentModelImpl.getColumnBitmask(
					columnName);
			}
	...
	public String getClassName() {
		return PaymentImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return PaymentTable.INSTANCE.getTableName();
	}
