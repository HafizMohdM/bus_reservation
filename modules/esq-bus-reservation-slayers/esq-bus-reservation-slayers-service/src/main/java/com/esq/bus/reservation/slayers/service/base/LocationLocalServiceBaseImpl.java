...
import com.esq.bus.reservation.slayers.service.LocationLocalService;
import com.esq.bus.reservation.slayers.service.LocationLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.LocationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.LocationLocalServiceImpl
 * @generated
 */
public abstract class LocationLocalServiceBaseImpl
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return locationPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LocationLocalServiceImpl#deleteLocation(Location) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LocationLocalServiceBaseImpl.class);
