...
import com.esq.bus.reservation.slayers.service.TransactionLogLocalService;
import com.esq.bus.reservation.slayers.service.TransactionLogLocalServiceUtil;
...
/**
 * Provides the base implementation for the transaction log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.TransactionLogLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.TransactionLogLocalServiceImpl
 * @generated
 */
public abstract class TransactionLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TransactionLogLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TransactionLogLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TransactionLogLocalServiceUtil</code>.
	 */
	...
	public TransactionLog addTransactionLog(TransactionLog transactionLog) {
		...
		return transactionLogPersistence.update(transactionLog);
	}
	...
	public TransactionLog createTransactionLog(long logId) {
		return transactionLogPersistence.create(logId);
	}
	...
	public TransactionLog deleteTransactionLog(long logId)
		...
		return transactionLogPersistence.remove(logId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return transactionLogPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TransactionLog.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return transactionLogPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return transactionLogPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TransactionLog fetchTransactionLog(long logId) {
		return transactionLogPersistence.fetchByPrimaryKey(logId);
	}
	...
	public TransactionLog getTransactionLog(long logId) throws PortalException {
		return transactionLogPersistence.findByPrimaryKey(logId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(transactionLogLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TransactionLog.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TransactionLog.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return transactionLogPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TransactionLogLocalServiceImpl#deleteTransactionLog(TransactionLog) to avoid orphaned data");
		}

		return transactionLogLocalService.deleteTransactionLog(
			(TransactionLog)persistedModel);
	}

	@Override
	public BasePersistence<TransactionLog> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TransactionLogLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		transactionLogLocalService = (TransactionLogLocalService)aopProxy;

		_setLocalServiceUtilService(transactionLogLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TransactionLogLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = TransactionLogLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, transactionLogLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TransactionLogLocalServiceBaseImpl.class);
