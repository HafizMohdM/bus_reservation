...
import com.esq.bus.reservation.slayers.service.AdminSettingLocalService;
...
/**
 * Provides the base implementation for the admin setting local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.AdminSettingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.AdminSettingLocalServiceImpl
 * @generated
 */
public abstract class AdminSettingLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AdminSettingLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>AdminSettingLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>AdminSettingLocalServiceUtil</code>.
	 */
	...
	public AdminSetting addAdminSetting(AdminSetting adminSetting) {
		...
		return adminSettingPersistence.update(adminSetting);
	}
	...
	public AdminSetting createAdminSetting(long settingId) {
		return adminSettingPersistence.create(settingId);
	}
	...
	public AdminSetting deleteAdminSetting(long settingId)
		...
		return adminSettingPersistence.remove(settingId);
	}
	...
	public AdminSetting deleteAdminSetting(AdminSetting adminSetting) {
		return adminSettingPersistence.remove(adminSetting);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return adminSettingPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			AdminSetting.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return adminSettingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return adminSettingPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return adminSettingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return adminSettingPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public AdminSetting fetchAdminSetting(long settingId) {
		return adminSettingPersistence.fetchByPrimaryKey(settingId);
	}
	...
	public AdminSetting getAdminSetting(long settingId) throws PortalException {
		return adminSettingPersistence.findByPrimaryKey(settingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(adminSettingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AdminSetting.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("settingId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			adminSettingLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AdminSetting.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("settingId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return adminSettingPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement AdminSettingLocalServiceImpl#deleteAdminSetting(AdminSetting) to avoid orphaned data");
		}

		return adminSettingLocalService.deleteAdminSetting(
			(AdminSetting)persistedModel);
	}

	@Override
	public BasePersistence<AdminSetting> getBasePersistence() {
		return adminSettingPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return adminSettingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AdminSetting> getAdminSettings(int start, int end) {
		return adminSettingPersistence.findAll(start, end);
	}
	...
	public int getAdminSettingsCount() {
		return adminSettingPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			AdminSettingLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		adminSettingLocalService = (AdminSettingLocalService)aopProxy;

		_setLocalServiceUtilService(adminSettingLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return AdminSettingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = adminSettingPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = AdminSettingLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, adminSettingLocalService);
		}
	...
	protected AdminSettingLocalService adminSettingLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		AdminSettingLocalServiceBaseImpl.class);
