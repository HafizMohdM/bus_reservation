...
import com.esq.bus.reservation.slayers.service.SupportTicketLocalService;
import com.esq.bus.reservation.slayers.service.SupportTicketLocalServiceUtil;
...
/**
 * Provides the base implementation for the support ticket local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.SupportTicketLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.SupportTicketLocalServiceImpl
 * @generated
 */
public abstract class SupportTicketLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, SupportTicketLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SupportTicketLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SupportTicketLocalServiceUtil</code>.
	 */
	...
	public SupportTicket addSupportTicket(SupportTicket supportTicket) {
		...
		return supportTicketPersistence.update(supportTicket);
	}
	...
	public SupportTicket createSupportTicket(long supportTicketId) {
		return supportTicketPersistence.create(supportTicketId);
	}
	...
	public SupportTicket deleteSupportTicket(long supportTicketId)
		...
		return supportTicketPersistence.remove(supportTicketId);
	}
	...
	public SupportTicket deleteSupportTicket(SupportTicket supportTicket) {
		return supportTicketPersistence.remove(supportTicket);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return supportTicketPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SupportTicket.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return supportTicketPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return supportTicketPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return supportTicketPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return supportTicketPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SupportTicket fetchSupportTicket(long supportTicketId) {
		return supportTicketPersistence.fetchByPrimaryKey(supportTicketId);
	}
	...
	public SupportTicket getSupportTicket(long supportTicketId)
		...
		return supportTicketPersistence.findByPrimaryKey(supportTicketId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(supportTicketLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SupportTicket.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("supportTicketId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SupportTicket.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return supportTicketPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SupportTicketLocalServiceImpl#deleteSupportTicket(SupportTicket) to avoid orphaned data");
		}

		return supportTicketLocalService.deleteSupportTicket(
			(SupportTicket)persistedModel);
	}

	@Override
	public BasePersistence<SupportTicket> getBasePersistence() {
		return supportTicketPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return supportTicketPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SupportTicket> getSupportTickets(int start, int end) {
		return supportTicketPersistence.findAll(start, end);
	}
	...
	public int getSupportTicketsCount() {
		return supportTicketPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SupportTicketLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		supportTicketLocalService = (SupportTicketLocalService)aopProxy;

		_setLocalServiceUtilService(supportTicketLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SupportTicketLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = supportTicketPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = SupportTicketLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, supportTicketLocalService);
		}
	...
	protected SupportTicketLocalService supportTicketLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SupportTicketLocalServiceBaseImpl.class);
