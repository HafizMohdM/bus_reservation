...
import com.esq.bus.reservation.slayers.service.BusUserLocalService;
...
/**
 * Provides the base implementation for the bus user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.BusUserLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.BusUserLocalServiceImpl
 * @generated
 */
public abstract class BusUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BusUserLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BusUserLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BusUserLocalServiceUtil</code>.
	 */
	...
	public BusUser addBusUser(BusUser busUser) {
		...
		return busUserPersistence.update(busUser);
	}
	...
	public BusUser createBusUser(long userId) {
		return busUserPersistence.create(userId);
	}
	...
	public BusUser deleteBusUser(long userId) throws PortalException {
		return busUserPersistence.remove(userId);
	}
	...
	public BusUser deleteBusUser(BusUser busUser) {
		return busUserPersistence.remove(busUser);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return busUserPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BusUser.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return busUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return busUserPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return busUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return busUserPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public BusUser fetchBusUser(long userId) {
		return busUserPersistence.fetchByPrimaryKey(userId);
	}
	...
	public BusUser getBusUser(long userId) throws PortalException {
		return busUserPersistence.findByPrimaryKey(userId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(busUserLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BusUser.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(BusUser.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return busUserPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BusUserLocalServiceImpl#deleteBusUser(BusUser) to avoid orphaned data");
		}

		return busUserLocalService.deleteBusUser((BusUser)persistedModel);
	}

	@Override
	public BasePersistence<BusUser> getBasePersistence() {
		return busUserPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return busUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<BusUser> getBusUsers(int start, int end) {
		return busUserPersistence.findAll(start, end);
	}
	...
	public int getBusUsersCount() {
		return busUserPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BusUserLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		busUserLocalService = (BusUserLocalService)aopProxy;

		_setLocalServiceUtilService(busUserLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BusUserLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = busUserPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		BusUserLocalService busUserLocalService) {

		try {
			Field field = BusUserLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, busUserLocalService);
		}
	...
	protected BusUserLocalService busUserLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BusUserLocalServiceBaseImpl.class);
