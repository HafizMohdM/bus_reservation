...
import com.esq.bus.reservation.slayers.model.DriverTable;
import com.esq.bus.reservation.slayers.model.impl.DriverImpl;
import com.esq.bus.reservation.slayers.model.impl.DriverModelImpl;
import com.esq.bus.reservation.slayers.service.persistence.DriverPersistence;
import com.esq.bus.reservation.slayers.service.persistence.DriverUtil;
...
public class DriverPersistenceImpl
	 ...
	 */
	@Override
	public List<Driver> findByuserId(long userId, int start, int end) {
	 ...
	 */
	@Override
	public List<Driver> findByuserId(
	...
	public Driver findByuserId_First(
		...
		Driver driver = fetchByuserId_First(userId, orderByComparator);
	...
	public Driver fetchByuserId_First(
		...
		List<Driver> list = findByuserId(userId, 0, 1, orderByComparator);
	...
	public Driver findByuserId_Last(
		...
		Driver driver = fetchByuserId_Last(userId, orderByComparator);
	...
	public Driver[] findByuserId_PrevAndNext(
		...
		try {
			...
			array[0] = getByuserId_PrevAndNext(
				session, driver, userId, orderByComparator, true);

			array[1] = driver;

			array[2] = getByuserId_PrevAndNext(
				session, driver, userId, orderByComparator, false);
	...
	protected Driver getByuserId_PrevAndNext(
		Session session, Driver driver, long userId,
	...
	public void activate() {
		...
		_setDriverUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setDriverUtilPersistence(null);

		entityCache.removeCache(DriverImpl.class.getName());
	}

	private void _setDriverUtilPersistence(
		DriverPersistence driverPersistence) {

		try {
			Field field = DriverUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, driverPersistence);
		}
