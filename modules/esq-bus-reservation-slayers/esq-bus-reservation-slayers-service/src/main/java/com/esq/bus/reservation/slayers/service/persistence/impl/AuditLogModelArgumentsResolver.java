...
/**
 * The arguments resolver class for retrieving value from AuditLog.
 *
 * @author Brian Wing Shun Chan
 * @generated
 */
@Component(service = ArgumentsResolver.class)
public class AuditLogModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= auditLogModelImpl.getColumnBitmask(
					columnName);
			}
	...
	public String getClassName() {
		return AuditLogImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return AuditLogTable.INSTANCE.getTableName();
	}
