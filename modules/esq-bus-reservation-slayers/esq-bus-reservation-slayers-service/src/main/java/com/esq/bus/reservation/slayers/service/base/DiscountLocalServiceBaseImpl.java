...
import com.esq.bus.reservation.slayers.service.DiscountLocalService;
...
/**
 * Provides the base implementation for the discount local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.DiscountLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.DiscountLocalServiceImpl
 * @generated
 */
public abstract class DiscountLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DiscountLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DiscountLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DiscountLocalServiceUtil</code>.
	 */
	...
	public Discount addDiscount(Discount discount) {
		...
		return discountPersistence.update(discount);
	}
	...
	public Discount createDiscount(long discountId) {
		return discountPersistence.create(discountId);
	}
	...
	public Discount deleteDiscount(long discountId) throws PortalException {
		return discountPersistence.remove(discountId);
	}
	...
	public Discount deleteDiscount(Discount discount) {
		return discountPersistence.remove(discount);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return discountPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Discount.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return discountPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return discountPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return discountPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return discountPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Discount fetchDiscount(long discountId) {
		return discountPersistence.fetchByPrimaryKey(discountId);
	}
	...
	public Discount getDiscount(long discountId) throws PortalException {
		return discountPersistence.findByPrimaryKey(discountId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(discountLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Discount.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("discountId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			discountLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Discount.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("discountId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return discountPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DiscountLocalServiceImpl#deleteDiscount(Discount) to avoid orphaned data");
		}

		return discountLocalService.deleteDiscount((Discount)persistedModel);
	}

	@Override
	public BasePersistence<Discount> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return discountPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Discount> getDiscounts(int start, int end) {
		return discountPersistence.findAll(start, end);
	}
	...
	public int getDiscountsCount() {
		return discountPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DiscountLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		discountLocalService = (DiscountLocalService)aopProxy;

		_setLocalServiceUtilService(discountLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DiscountLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = discountPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DiscountLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, discountLocalService);
		}
	...
	protected DiscountLocalService discountLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DiscountLocalServiceBaseImpl.class);
