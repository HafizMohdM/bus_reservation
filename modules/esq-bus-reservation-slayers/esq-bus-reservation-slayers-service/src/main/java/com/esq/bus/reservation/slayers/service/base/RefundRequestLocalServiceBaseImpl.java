...
import com.esq.bus.reservation.slayers.service.RefundRequestLocalService;
...
/**
 * Provides the base implementation for the refund request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.RefundRequestLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.RefundRequestLocalServiceImpl
 * @generated
 */
public abstract class RefundRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, RefundRequestLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RefundRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RefundRequestLocalServiceUtil</code>.
	 */
	...
	public RefundRequest addRefundRequest(RefundRequest refundRequest) {
		...
		return refundRequestPersistence.update(refundRequest);
	}
	...
	public RefundRequest createRefundRequest(long requestId) {
		return refundRequestPersistence.create(requestId);
	}
	...
	public RefundRequest deleteRefundRequest(long requestId)
		...
		return refundRequestPersistence.remove(requestId);
	}
	...
	public RefundRequest deleteRefundRequest(RefundRequest refundRequest) {
		return refundRequestPersistence.remove(refundRequest);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return refundRequestPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RefundRequest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return refundRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return refundRequestPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return refundRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return refundRequestPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public RefundRequest fetchRefundRequest(long requestId) {
		return refundRequestPersistence.fetchByPrimaryKey(requestId);
	}
	...
	public RefundRequest getRefundRequest(long requestId)
		...
		return refundRequestPersistence.findByPrimaryKey(requestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(refundRequestLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RefundRequest.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			refundRequestLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RefundRequest.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return refundRequestPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement RefundRequestLocalServiceImpl#deleteRefundRequest(RefundRequest) to avoid orphaned data");
		}

		return refundRequestLocalService.deleteRefundRequest(
			(RefundRequest)persistedModel);
	}

	@Override
	public BasePersistence<RefundRequest> getBasePersistence() {
		return refundRequestPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return refundRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<RefundRequest> getRefundRequests(int start, int end) {
		return refundRequestPersistence.findAll(start, end);
	}
	...
	public int getRefundRequestsCount() {
		return refundRequestPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RefundRequestLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		refundRequestLocalService = (RefundRequestLocalService)aopProxy;

		_setLocalServiceUtilService(refundRequestLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RefundRequestLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = refundRequestPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = RefundRequestLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, refundRequestLocalService);
		}
	...
	protected RefundRequestLocalService refundRequestLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RefundRequestLocalServiceBaseImpl.class);
