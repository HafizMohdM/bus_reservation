...
import com.esq.bus.reservation.slayers.service.PaymentLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.PaymentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.PaymentLocalServiceImpl
 * @generated
 */
public abstract class PaymentLocalServiceBaseImpl
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return paymentPersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PaymentLocalServiceImpl#deletePayment(Payment) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PaymentLocalServiceBaseImpl.class);
