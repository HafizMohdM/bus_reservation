...
import com.esq.bus.reservation.slayers.service.BookingLocalService;
import com.esq.bus.reservation.slayers.service.BookingLocalServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.BookingLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.BookingLocalServiceImpl
 * @generated
 */
public abstract class BookingLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BookingLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BookingLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BookingLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return bookingPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Booking.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return bookingPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return bookingPersistence.countWithDynamicQuery(
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return bookingPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BookingLocalServiceImpl#deleteBooking(Booking) to avoid orphaned data");
		}
	...
	@Override
	public BasePersistence<Booking> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BookingLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		bookingLocalService = (BookingLocalService)aopProxy;

		_setLocalServiceUtilService(bookingLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = BookingLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, bookingLocalService);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BookingLocalServiceBaseImpl.class);
