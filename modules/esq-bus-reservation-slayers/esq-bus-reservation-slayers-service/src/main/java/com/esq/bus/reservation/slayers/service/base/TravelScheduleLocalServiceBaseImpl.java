...
import com.esq.bus.reservation.slayers.service.TravelScheduleLocalService;
import com.esq.bus.reservation.slayers.service.TravelScheduleLocalServiceUtil;
...
/**
 * Provides the base implementation for the travel schedule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.esq.bus.reservation.slayers.service.impl.TravelScheduleLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.esq.bus.reservation.slayers.service.impl.TravelScheduleLocalServiceImpl
 * @generated
 */
public abstract class TravelScheduleLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TravelScheduleLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelScheduleLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelScheduleLocalServiceUtil</code>.
	 */
	...
	public TravelSchedule addTravelSchedule(TravelSchedule travelSchedule) {
		...
		return travelSchedulePersistence.update(travelSchedule);
	}
	...
	public TravelSchedule createTravelSchedule(long scheduleId) {
		return travelSchedulePersistence.create(scheduleId);
	}
	...
	public TravelSchedule deleteTravelSchedule(long scheduleId)
		...
		return travelSchedulePersistence.remove(scheduleId);
	}
	...
	public TravelSchedule deleteTravelSchedule(TravelSchedule travelSchedule) {
		return travelSchedulePersistence.remove(travelSchedule);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return travelSchedulePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TravelSchedule.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelSchedulePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return travelSchedulePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelSchedulePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return travelSchedulePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TravelSchedule fetchTravelSchedule(long scheduleId) {
		return travelSchedulePersistence.fetchByPrimaryKey(scheduleId);
	}
	...
	public TravelSchedule getTravelSchedule(long scheduleId)
		...
		return travelSchedulePersistence.findByPrimaryKey(scheduleId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(travelScheduleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TravelSchedule.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TravelSchedule.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return travelSchedulePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TravelScheduleLocalServiceImpl#deleteTravelSchedule(TravelSchedule) to avoid orphaned data");
		}

		return travelScheduleLocalService.deleteTravelSchedule(
			(TravelSchedule)persistedModel);
	}

	@Override
	public BasePersistence<TravelSchedule> getBasePersistence() {
		return travelSchedulePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return travelSchedulePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TravelSchedule> getTravelSchedules(int start, int end) {
		return travelSchedulePersistence.findAll(start, end);
	}
	...
	public int getTravelSchedulesCount() {
		return travelSchedulePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelScheduleLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelScheduleLocalService = (TravelScheduleLocalService)aopProxy;

		_setLocalServiceUtilService(travelScheduleLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelScheduleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = travelSchedulePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = TravelScheduleLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, travelScheduleLocalService);
		}
	...
	protected TravelScheduleLocalService travelScheduleLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TravelScheduleLocalServiceBaseImpl.class);
