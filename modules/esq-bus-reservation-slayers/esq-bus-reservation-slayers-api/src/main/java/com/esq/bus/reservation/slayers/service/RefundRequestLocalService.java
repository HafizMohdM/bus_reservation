...
/**
 * Provides the local service interface for RefundRequest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RefundRequestLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RefundRequestLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.RefundRequestLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the refund request local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RefundRequestLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public RefundRequest addRefundRequest(RefundRequest refundRequest);
	...
	public RefundRequest createRefundRequest(long requestId);
	...
	public RefundRequest deleteRefundRequest(long requestId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public RefundRequest deleteRefundRequest(RefundRequest refundRequest);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RefundRequest fetchRefundRequest(long requestId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RefundRequest getRefundRequest(long requestId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RefundRequest> getRefundRequests(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RefundRequest updateRefundRequest(RefundRequest refundRequest);
