...
/**
 * Provides the local service interface for BusUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BusUserLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BusUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.BusUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the bus user local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BusUserLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public BusUser addBusUser(BusUser busUser);
	...
	public BusUser createBusUser(long userId);
	...
	public BusUser deleteBusUser(BusUser busUser);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public BusUser deleteBusUser(long userId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BusUser fetchBusUser(long userId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public BusUser getBusUser(long userId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BusUser> getBusUsers(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public BusUser updateBusUser(BusUser busUser);
