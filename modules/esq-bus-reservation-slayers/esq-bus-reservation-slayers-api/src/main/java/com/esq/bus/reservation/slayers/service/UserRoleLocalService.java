...
/**
 * Provides the local service interface for UserRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserRoleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserRoleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.UserRoleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user role local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserRoleLocalServiceUtil} if injection and service tracking are not available.
	 */
