...
public interface RouteLocalService
	...
	public Route deleteRoute(long routeId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Route getRoute(long routeId) throws PortalException;
