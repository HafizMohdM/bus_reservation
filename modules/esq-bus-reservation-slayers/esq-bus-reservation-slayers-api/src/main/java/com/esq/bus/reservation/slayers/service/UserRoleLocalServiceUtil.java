 ...
 * <code>com.esq.bus.reservation.slayers.service.impl.UserRoleLocalServiceImpl</code> and
...
public class UserRoleLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.UserRoleLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static UserRole createUserRole(long userRoleId) {
		return getService().createUserRole(userRoleId);
	}
	 ...
	 */
	public static UserRole deleteUserRole(long userRoleId)
		throws PortalException {

		return getService().deleteUserRole(userRoleId);
	}
	...
	public static UserRole fetchUserRole(long userRoleId) {
		return getService().fetchUserRole(userRoleId);
	}
	 ...
	 * @throws PortalException if a user role with the primary key could not be found
	 */
	public static UserRole getUserRole(long userRoleId) throws PortalException {
		return getService().getUserRole(userRoleId);
	}
