...
/**
 * Provides the local service interface for Discount. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DiscountLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DiscountLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.DiscountLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the discount local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DiscountLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Discount createDiscount(long discountId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Discount deleteDiscount(long discountId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Discount fetchDiscount(long discountId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Discount getDiscount(long discountId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Discount> getDiscounts(int start, int end);
