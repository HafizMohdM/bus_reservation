...
/**
 * Provides the local service interface for SupportTicket. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SupportTicketLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SupportTicketLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.SupportTicketLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the support ticket local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SupportTicketLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SupportTicket createSupportTicket(long supportTicketId);
	...
	public SupportTicket deleteSupportTicket(long supportTicketId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SupportTicket fetchSupportTicket(long supportTicketId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SupportTicket getSupportTicket(long supportTicketId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SupportTicket> getSupportTickets(int start, int end);
