...
/**
 * Provides the local service utility for RefundRequest. This utility wraps
 * <code>com.esq.bus.reservation.slayers.service.impl.RefundRequestLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RefundRequestLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.RefundRequestLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RefundRequest addRefundRequest(RefundRequest refundRequest) {
		return getService().addRefundRequest(refundRequest);
	}
	 ...
	 */
	public static RefundRequest createRefundRequest(long requestId) {
		return getService().createRefundRequest(requestId);
	}
	 ...
	 */
	public static RefundRequest deleteRefundRequest(long requestId)
		throws PortalException {

		return getService().deleteRefundRequest(requestId);
	}
	 ...
	 * @return the refund request that was removed
	 */
	public static RefundRequest deleteRefundRequest(
		RefundRequest refundRequest) {

		return getService().deleteRefundRequest(refundRequest);
	}
	...
	public static RefundRequest fetchRefundRequest(long requestId) {
		return getService().fetchRefundRequest(requestId);
	}
	 ...
	 * @throws PortalException if a refund request with the primary key could not be found
	 */
	public static RefundRequest getRefundRequest(long requestId)
		throws PortalException {

		return getService().getRefundRequest(requestId);
	}
	 ...
	 */
	public static List<RefundRequest> getRefundRequests(int start, int end) {
		return getService().getRefundRequests(start, end);
	}
	 ...
	 */
	public static int getRefundRequestsCount() {
		return getService().getRefundRequestsCount();
	}
	 ...
	 */
	public static RefundRequest updateRefundRequest(
		RefundRequest refundRequest) {

		return getService().updateRefundRequest(refundRequest);
	}

	public static RefundRequestLocalService getService() {
		return _service;
	}

	private static volatile RefundRequestLocalService _service;
