...
/**
 * Provides the local service utility for Seat. This utility wraps
 * <code>com.esq.bus.reservation.slayers.service.impl.SeatLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SeatLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.SeatLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Seat addSeat(Seat seat) {
		return getService().addSeat(seat);
	}
	...
	public static Seat createSeat(long seatId) {
		return getService().createSeat(seatId);
	}
	 ...
	 */
	public static Seat deleteSeat(long seatId) throws PortalException {
		return getService().deleteSeat(seatId);
	}
	 ...
	 * @return the seat that was removed
	 */
	public static Seat deleteSeat(Seat seat) {
		return getService().deleteSeat(seat);
	}
	...
	public static Seat fetchSeat(long seatId) {
		return getService().fetchSeat(seatId);
	}
	 ...
	 * @throws PortalException if a seat with the primary key could not be found
	 */
	public static Seat getSeat(long seatId) throws PortalException {
		return getService().getSeat(seatId);
	}
	 ...
	 */
	public static List<Seat> getSeats(int start, int end) {
		return getService().getSeats(start, end);
	}
	...
	public static int getSeatsCount() {
		return getService().getSeatsCount();
	}
	 ...
	 */
	public static Seat updateSeat(Seat seat) {
		return getService().updateSeat(seat);
	}

	public static SeatLocalService getService() {
		return _service;
	}

	private static volatile SeatLocalService _service;
