 ...
 * <code>com.esq.bus.reservation.slayers.service.impl.DiscountLocalServiceImpl</code> and
...
public class DiscountLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.DiscountLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Discount createDiscount(long discountId) {
		return getService().createDiscount(discountId);
	}
	 ...
	 */
	public static Discount deleteDiscount(Discount discount) {
	 ...
	 */
	public static Discount deleteDiscount(long discountId)
		throws PortalException {

		return getService().deleteDiscount(discountId);
	}
	...
	public static Discount fetchDiscount(long discountId) {
		return getService().fetchDiscount(discountId);
	}
	 ...
	 * @throws PortalException if a discount with the primary key could not be found
	 */
	public static Discount getDiscount(long discountId) throws PortalException {
		return getService().getDiscount(discountId);
	}
	 ...
	 */
	public static List<Discount> getDiscounts(int start, int end) {
	...
	private static volatile DiscountLocalService _service;
