...
/**
 * Provides the local service interface for Passenger. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PassengerLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PassengerLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.PassengerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the passenger local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PassengerLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Passenger createPassenger(long passengerId);
	...
	public Passenger deletePassenger(long passengerId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Passenger fetchPassenger(long passengerId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Passenger getPassenger(long passengerId) throws PortalException;
