...
/**
 * Provides the local service interface for TransactionLog. Methods of this
...
public interface TransactionLogLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.TransactionLogLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the transaction log local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TransactionLogLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TransactionLog createTransactionLog(long logId);
	...
	public TransactionLog deleteTransactionLog(long logId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TransactionLog fetchTransactionLog(long logId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TransactionLog getTransactionLog(long logId) throws PortalException;
