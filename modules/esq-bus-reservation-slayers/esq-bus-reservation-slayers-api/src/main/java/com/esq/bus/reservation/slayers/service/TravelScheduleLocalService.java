...
/**
 * Provides the local service interface for TravelSchedule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TravelScheduleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TravelScheduleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.TravelScheduleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the travel schedule local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TravelScheduleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TravelSchedule addTravelSchedule(TravelSchedule travelSchedule);
	...
	public TravelSchedule createTravelSchedule(long scheduleId);
	...
	public TravelSchedule deleteTravelSchedule(long scheduleId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TravelSchedule deleteTravelSchedule(TravelSchedule travelSchedule);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TravelSchedule fetchTravelSchedule(long scheduleId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TravelSchedule getTravelSchedule(long scheduleId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TravelSchedule> getTravelSchedules(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TravelSchedule updateTravelSchedule(TravelSchedule travelSchedule);
