...
/**
 * The persistence utility for the ticket service. This utility wraps <code>com.esq.bus.reservation.slayers.service.persistence.impl.TicketPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TicketUtil {
	...
	public static Ticket remove(long ticketId)
		throws com.esq.bus.reservation.slayers.exception.NoSuchTicketException {
