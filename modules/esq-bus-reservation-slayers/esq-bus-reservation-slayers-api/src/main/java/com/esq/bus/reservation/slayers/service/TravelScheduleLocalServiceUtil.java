...
/**
 * Provides the local service utility for TravelSchedule. This utility wraps
 * <code>com.esq.bus.reservation.slayers.service.impl.TravelScheduleLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TravelScheduleLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.TravelScheduleLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TravelSchedule addTravelSchedule(
		TravelSchedule travelSchedule) {

		return getService().addTravelSchedule(travelSchedule);
	}
	 ...
	 */
	public static TravelSchedule createTravelSchedule(long scheduleId) {
		return getService().createTravelSchedule(scheduleId);
	}
	 ...
	 */
	public static TravelSchedule deleteTravelSchedule(long scheduleId)
		throws PortalException {

		return getService().deleteTravelSchedule(scheduleId);
	}
	 ...
	 * @return the travel schedule that was removed
	 */
	public static TravelSchedule deleteTravelSchedule(
		TravelSchedule travelSchedule) {

		return getService().deleteTravelSchedule(travelSchedule);
	}
	...
	public static TravelSchedule fetchTravelSchedule(long scheduleId) {
		return getService().fetchTravelSchedule(scheduleId);
	}
	 ...
	 * @throws PortalException if a travel schedule with the primary key could not be found
	 */
	public static TravelSchedule getTravelSchedule(long scheduleId)
		throws PortalException {

		return getService().getTravelSchedule(scheduleId);
	}
	 ...
	 */
	public static List<TravelSchedule> getTravelSchedules(int start, int end) {
		return getService().getTravelSchedules(start, end);
	}
	 ...
	 */
	public static int getTravelSchedulesCount() {
		return getService().getTravelSchedulesCount();
	}
	 ...
	 */
	public static TravelSchedule updateTravelSchedule(
		TravelSchedule travelSchedule) {

		return getService().updateTravelSchedule(travelSchedule);
	}

	public static TravelScheduleLocalService getService() {
		return _service;
	}

	private static volatile TravelScheduleLocalService _service;
