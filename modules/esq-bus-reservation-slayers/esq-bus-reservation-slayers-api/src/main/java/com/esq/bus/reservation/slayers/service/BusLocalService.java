...
/**
 * Provides the local service interface for Bus. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BusLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BusLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.BusLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the bus local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BusLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Bus createBus(long busId);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Bus deleteBus(long busId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Bus fetchBus(long busId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Bus getBus(long busId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Bus> getBuses(int start, int end);
