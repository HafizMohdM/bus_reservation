...
/**
 * Provides the local service interface for AdminSetting. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AdminSettingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AdminSettingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.AdminSettingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the admin setting local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AdminSettingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AdminSetting addAdminSetting(AdminSetting adminSetting);
	...
	public AdminSetting createAdminSetting(long settingId);
	...
	public AdminSetting deleteAdminSetting(AdminSetting adminSetting);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AdminSetting deleteAdminSetting(long settingId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AdminSetting fetchAdminSetting(long settingId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AdminSetting getAdminSetting(long settingId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AdminSetting> getAdminSettings(int start, int end);
