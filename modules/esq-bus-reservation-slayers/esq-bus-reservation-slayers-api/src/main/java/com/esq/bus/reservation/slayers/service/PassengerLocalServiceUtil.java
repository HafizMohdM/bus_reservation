...
/**
 * Provides the local service utility for Passenger. This utility wraps
 * <code>com.esq.bus.reservation.slayers.service.impl.PassengerLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PassengerLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.PassengerLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static Passenger addPassenger(Passenger passenger) {
		return getService().addPassenger(passenger);
	}
	 ...
	 */
	public static Passenger createPassenger(long passengerId) {
		return getService().createPassenger(passengerId);
	}
	 ...
	 */
	public static Passenger deletePassenger(long passengerId)
		throws PortalException {

		return getService().deletePassenger(passengerId);
	}
	 ...
	 * @return the passenger that was removed
	 */
	public static Passenger deletePassenger(Passenger passenger) {
		return getService().deletePassenger(passenger);
	}
	...
	public static Passenger fetchPassenger(long passengerId) {
		return getService().fetchPassenger(passengerId);
	}
	...
	public static Passenger getPassenger(long passengerId)
		...
		return getService().getPassenger(passengerId);
	}
	 ...
	 */
	public static List<Passenger> getPassengers(int start, int end) {
		return getService().getPassengers(start, end);
	}
	...
	public static int getPassengersCount() {
		return getService().getPassengersCount();
	}
	...
	public static Passenger updatePassenger(Passenger passenger) {
		return getService().updatePassenger(passenger);
	}

	public static PassengerLocalService getService() {
		return _service;
	}

	private static volatile PassengerLocalService _service;
