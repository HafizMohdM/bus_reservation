...
/**
 * Provides the local service utility for SupportTicket. This utility wraps
 * <code>com.esq.bus.reservation.slayers.service.impl.SupportTicketLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SupportTicketLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.SupportTicketLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static SupportTicket addSupportTicket(SupportTicket supportTicket) {
		return getService().addSupportTicket(supportTicket);
	}
	 ...
	 */
	public static SupportTicket createSupportTicket(long supportTicketId) {
		return getService().createSupportTicket(supportTicketId);
	}
	 ...
	 */
	public static SupportTicket deleteSupportTicket(long supportTicketId)
		throws PortalException {

		return getService().deleteSupportTicket(supportTicketId);
	}
	 ...
	 * @return the support ticket that was removed
	 */
	public static SupportTicket deleteSupportTicket(
		SupportTicket supportTicket) {

		return getService().deleteSupportTicket(supportTicket);
	}
	...
	public static SupportTicket fetchSupportTicket(long supportTicketId) {
		return getService().fetchSupportTicket(supportTicketId);
	}
	 ...
	 * @throws PortalException if a support ticket with the primary key could not be found
	 */
	public static SupportTicket getSupportTicket(long supportTicketId)
		throws PortalException {

		return getService().getSupportTicket(supportTicketId);
	}
	 ...
	 */
	public static List<SupportTicket> getSupportTickets(int start, int end) {
		return getService().getSupportTickets(start, end);
	}
	 ...
	 */
	public static int getSupportTicketsCount() {
		return getService().getSupportTicketsCount();
	}
	 ...
	 */
	public static SupportTicket updateSupportTicket(
		SupportTicket supportTicket) {

		return getService().updateSupportTicket(supportTicket);
	}

	public static SupportTicketLocalService getService() {
		return _service;
	}

	private static volatile SupportTicketLocalService _service;
