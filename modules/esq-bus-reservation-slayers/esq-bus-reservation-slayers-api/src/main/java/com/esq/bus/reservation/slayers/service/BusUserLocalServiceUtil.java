...
/**
 * Provides the local service utility for BusUser. This utility wraps
 * <code>com.esq.bus.reservation.slayers.service.impl.BusUserLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BusUserLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.esq.bus.reservation.slayers.service.impl.BusUserLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static BusUser addBusUser(BusUser busUser) {
		return getService().addBusUser(busUser);
	}
	 ...
	 */
	public static BusUser createBusUser(long userId) {
		return getService().createBusUser(userId);
	}
	 ...
	 */
	public static BusUser deleteBusUser(BusUser busUser) {
		return getService().deleteBusUser(busUser);
	}
	 ...
	 */
	public static BusUser deleteBusUser(long userId) throws PortalException {
		return getService().deleteBusUser(userId);
	}
	...
	public static BusUser fetchBusUser(long userId) {
		return getService().fetchBusUser(userId);
	}
	 ...
	 * @throws PortalException if a bus user with the primary key could not be found
	 */
	public static BusUser getBusUser(long userId) throws PortalException {
		return getService().getBusUser(userId);
	}
	 ...
	 */
	public static List<BusUser> getBusUsers(int start, int end) {
		return getService().getBusUsers(start, end);
	}
	 ...
	 */
	public static int getBusUsersCount() {
		return getService().getBusUsersCount();
	}
	 ...
	 */
	public static BusUser updateBusUser(BusUser busUser) {
		return getService().updateBusUser(busUser);
	}

	public static BusUserLocalService getService() {
		return _service;
	}

	private static volatile BusUserLocalService _service;
