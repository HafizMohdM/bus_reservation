...
import EsquareEmployee_Slayer.exception.NoSuchEmployeesException;
...
import EsquareEmployee_Slayer.service.persistence.EmployeesUtil;
import EsquareEmployee_Slayer.service.persistence.impl.constants.esquarePersistenceConstants;
...
public class EmployeesPersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindByemployeeDesignation;
	private FinderPath _finderPathWithoutPaginationFindByemployeeDesignation;
	private FinderPath _finderPathCountByemployeeDesignation;

	/**
	 * Returns all the employeeses where employeeDesignation = &#63;.
	 *
	 * @param employeeDesignation the employee designation
	 * @return the matching employeeses
	 */
	@Override
	public List<Employees> findByemployeeDesignation(
		String employeeDesignation) {

		return findByemployeeDesignation(
			employeeDesignation, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the employeeses where employeeDesignation = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeesModelImpl</code>.
	 * </p>
	...
	@Override
	public List<Employees> findByemployeeDesignation(
		String employeeDesignation, int start, int end) {

		return findByemployeeDesignation(employeeDesignation, start, end, null);
	}

	/**
	 * Returns an ordered range of all the employeeses where employeeDesignation = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>EmployeesModelImpl</code>.
	 * </p>
	...
	public List<Employees> findByemployeeDesignation(
		...
		return findByemployeeDesignation(
			employeeDesignation, start, end, orderByComparator, true);
	}
	...
	public List<Employees> findByemployeeDesignation(
		...
		employeeDesignation = Objects.toString(employeeDesignation, "");
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath =
					_finderPathWithoutPaginationFindByemployeeDesignation;
				finderArgs = new Object[] {employeeDesignation};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByemployeeDesignation;
			finderArgs = new Object[] {
				employeeDesignation, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			boolean bindEmployeeDesignation = false;

			if (employeeDesignation.isEmpty()) {
				sb.append(
					_FINDER_COLUMN_EMPLOYEEDESIGNATION_EMPLOYEEDESIGNATION_3);
			}
			else {
				bindEmployeeDesignation = true;

				sb.append(
					_FINDER_COLUMN_EMPLOYEEDESIGNATION_EMPLOYEEDESIGNATION_2);
			}
			...
			try {
				...
				if (bindEmployeeDesignation) {
					queryPos.add(employeeDesignation);
				}
	...
	/**
	 * Returns the first employees in the ordered set where employeeDesignation = &#63;.
	 *
	 * @param employeeDesignation the employee designation
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching employees
	 ...
	 */
	@Override
	public Employees findByemployeeDesignation_First(
			String employeeDesignation,
			OrderByComparator<Employees> orderByComparator)
		throws NoSuchEmployeesException {

		Employees employees = fetchByemployeeDesignation_First(
	 ...
	 */
	@Override
	public Employees fetchByemployeeDesignation_First(
		String employeeDesignation,
		OrderByComparator<Employees> orderByComparator) {

		List<Employees> list = findByemployeeDesignation(
			employeeDesignation, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last employees in the ordered set where employeeDesignation = &#63;.
	 *
	 * @param employeeDesignation the employee designation
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching employees
	 ...
	 */
	@Override
	public Employees findByemployeeDesignation_Last(
			String employeeDesignation,
			OrderByComparator<Employees> orderByComparator)
		throws NoSuchEmployeesException {

		Employees employees = fetchByemployeeDesignation_Last(
			employeeDesignation, orderByComparator);
	 ...
	 */
	@Override
	public Employees fetchByemployeeDesignation_Last(
		String employeeDesignation,
		OrderByComparator<Employees> orderByComparator) {

		int count = countByemployeeDesignation(employeeDesignation);
		...
		List<Employees> list = findByemployeeDesignation(
			employeeDesignation, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the employeeses before and after the current employees in the ordered set where employeeDesignation = &#63;.
	 *
	 * @param employeeId the primary key of the current employees
	 * @param employeeDesignation the employee designation
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Employees[] findByemployeeDesignation_PrevAndNext(
			long employeeId, String employeeDesignation,
			OrderByComparator<Employees> orderByComparator)
		throws NoSuchEmployeesException {
		...
		try {
			...
			array[0] = getByemployeeDesignation_PrevAndNext(
				session, employees, employeeDesignation, orderByComparator,
				true);

			array[1] = employees;

			array[2] = getByemployeeDesignation_PrevAndNext(
				session, employees, employeeDesignation, orderByComparator,
				false);
	...
	protected Employees getByemployeeDesignation_PrevAndNext(
		Session session, Employees employees, String employeeDesignation,
		OrderByComparator<Employees> orderByComparator, boolean previous) {
		...
		if (employeeDesignation.isEmpty()) {
			sb.append(_FINDER_COLUMN_EMPLOYEEDESIGNATION_EMPLOYEEDESIGNATION_3);
		}
		else {
			bindEmployeeDesignation = true;

			sb.append(_FINDER_COLUMN_EMPLOYEEDESIGNATION_EMPLOYEEDESIGNATION_2);
		}
	...
	/**
	 * Removes all the employeeses where employeeDesignation = &#63; from the database.
	 *
	 * @param employeeDesignation the employee designation
	 */
	@Override
	public void removeByemployeeDesignation(String employeeDesignation) {
		for (Employees employees :
				findByemployeeDesignation(
					employeeDesignation, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
					null)) {
	...
	/**
	 * Returns the number of employeeses where employeeDesignation = &#63;.
	 *
	 * @param employeeDesignation the employee designation
	 * @return the number of matching employeeses
	 */
	@Override
	public int countByemployeeDesignation(String employeeDesignation) {
		employeeDesignation = Objects.toString(employeeDesignation, "");

		FinderPath finderPath = _finderPathCountByemployeeDesignation;

		Object[] finderArgs = new Object[] {employeeDesignation};
	...
	private static final String
		_FINDER_COLUMN_EMPLOYEEDESIGNATION_EMPLOYEEDESIGNATION_3 =
			"(employees.employeeDesignation IS NULL OR employees.employeeDesignation = '')";
	...
	public void activate() {
		...
		_finderPathWithPaginationFindByemployeeDesignation = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByemployeeDesignation",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"employeeDesignation"}, true);

		_finderPathWithoutPaginationFindByemployeeDesignation = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByemployeeDesignation", new String[] {String.class.getName()},
			new String[] {"employeeDesignation"}, true);

		_finderPathCountByemployeeDesignation = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByemployeeDesignation", new String[] {String.class.getName()},
			new String[] {"employeeDesignation"}, false);
