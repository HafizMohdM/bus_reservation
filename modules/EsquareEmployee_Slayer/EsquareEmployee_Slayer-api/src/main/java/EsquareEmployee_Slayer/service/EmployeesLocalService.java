...
public interface EmployeesLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>EsquareEmployee_Slayer.service.impl.EmployeesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employees local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Employees addEmployees(
		...
		InputStream empPhotoStream, ServiceContext serviceContext);
