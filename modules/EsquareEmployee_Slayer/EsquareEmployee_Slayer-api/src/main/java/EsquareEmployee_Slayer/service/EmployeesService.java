...
public interface EmployeesService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>EsquareEmployee_Slayer.service.impl.EmployeesServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the employees remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EmployeesServiceUtil} if injection and service tracking are not available.
	 */
